...
domains=(dashboard.teamcity.jet-omega.com keycloak.jet-omega.com)

rsa_key_size=4096
data_path="./data/certbot"

email="vrdept@omegafuture.ru" # Adding a valid address is strongly recommended, please add your own email !
